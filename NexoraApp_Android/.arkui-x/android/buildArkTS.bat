...
set project_path=F:\Code\AI\ChatDB\NexoraApp_Android
set ohpm_path=F:\Code\Program\DevEco Studio\tools\ohpm\bin\ohpm
set arkuiXSdkPath=G:\Temp\Huawei\SDK\ArkUI_X_SDK\26.0.0\arkui-x
